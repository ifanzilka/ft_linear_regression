...
class Logger():
    def __init__(self, env_path, project, experiment_name=None):
        ...
        self.run = neptune.init_run(
            project=project,
            api_token='eyJhcGlfYWRkcmVzcyI6Imh0dHBzOi8vYXBwLm5lcHR1bmUuYWkiLCJhcGlfdXJsIjoiaHR0cHM6Ly9hcHAubmVwdHVuZS5haSIsImFwaV9rZXkiOiI1NTBhZWU4ZS0wODJiLTQ0MTctOTE3OC00MTA2OTBmMTljNTUifQ==',
    ...
    def log_final_val_loss(self, value: float):
        # сохранение финальное значение mse на валидационной выборке
        self.run['final_metrics/validation_loss'] = value
